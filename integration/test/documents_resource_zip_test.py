...
class DocumentsResourceZipTest(AbstractTestCase):
    ...
    def test_add_and_get_documents_from_zip(self):
        ...
        self.__test_get_latest_version(document_locations)
    ...
    def __test_get_latest_version_of_documents(self, document_locations):
        expected_sha_1 = (
                'bf83caeb324ec7d185e8bf266d97ca9354732b76eee46b6227adb082')
        expected_sha_2 = (
                '4fcc5672305c87f66f09c39f7229fd126cab95edf30821ec9ee4a66f')

        self.__test_get_latest_version(document_locations[0], "Een.\n",
                                       expected_sha_1)
        self.__test_get_latest_version(document_locations[1], "Twee.\n",
                                       expected_sha_2)
    ...
    def __test_files_are_in_files_index(self, es_host, document_locations):
        self.__test_file_in_index("Een.\n",  document_locations[0], es_host)
        self.__test_file_in_index("Twee.\n", document_locations[1], es_host)

    def __test_file_in_index(self, content, document_location, es_host):
