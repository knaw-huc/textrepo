...
docker-compose -f docker-compose-local.yml stop textrepo-app

# Then gracefully stop postgres, waiting until it is done.
docker-compose -f docker-compose-local.yml exec -u postgres postgres pg_ctl stop --mode=smart --wait
