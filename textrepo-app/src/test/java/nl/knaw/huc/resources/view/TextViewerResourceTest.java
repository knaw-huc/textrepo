...
class TextViewerResourceTest {
  ...
  private static Stream<Arguments> provideCases() {
    return Stream.of(
        ...
        Arguments.of("/chars/4/1000", 400, "must be <="),
        Arguments.of("/chars/full/1000", 400, "must be <="),
        ...
        Arguments.of("/chars/33/33", 400, "must be <= 32"),
        ...
        Arguments.of("/lines/0/2", 400, "must be <= 1"),
